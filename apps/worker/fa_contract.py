...
MACRO_SIGNALS: tuple[MacroSignalContract, ...] = (
    ...
    MacroSignalContract("ISM_PMI", "MANUFACTURING", "MONTHLY", "LEVEL", "FRED", "NAPMPMI", "SOURCE_RELEASE_DATE"),
...
REQUIRED_MACRO_CODES = tuple(signal.code for signal in MACRO_SIGNALS)
