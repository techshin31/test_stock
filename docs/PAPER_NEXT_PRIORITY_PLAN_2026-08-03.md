...
## 최신 장중 진단 증거 부록 (2026-08-03 14:18 KST)
...
- 신호 증거 검증: 65건 관측, 65건 유효, 0건 무효 (`validity_rate=1.0`)
- 금일 데이터 품질: scan 300건, 신호 증거 65건 유효 (`coverage_rate=0.2167`)
...
## Shadow 관측 가능성 점검 (2026-08-03 15:53 KST)

- 현재 대시보드·shadow 입력 가격 데이터의 최신일은 `2026-07-31`이며 `2026-08-03` 가격 근거 파일은 확인되지 않음
- 따라서 2026-08-03을 shadow 관측 세션으로 임의 추가하지 않음
- shadow는 검증 가능한 세션 9/10, portfolio-cap challenger는 4회로 유지하며 다음 유효 가격 세션부터 누적함
